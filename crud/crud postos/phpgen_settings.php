...
{
    $result = array();
    $result[] = array('caption' => 'Postos', 'short_caption' => 'Postos', 'filename' => 'postos.php', 'name' => 'postos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Precos', 'short_caption' => 'Precos', 'filename' => 'precos.php', 'name' => 'precos', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
